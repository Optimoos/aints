...
public:
    ...
    public:
        ...
        void StartTimer(int64_t time_until_expiry) {this->expired = false; this->block = World::GetBlockAtPos(position); this->expiry = time_until_expiry; this->expiry_clock = std::chrono::steady_clock::now();};
